...
public class RecordingSensor extends AbstractSensor<Long> {
    ...
    /**
     * The id of the {@link gotovoid.de.gotovoid.database.model.Recording} the sensor data is for.
     */
    ...
    /**
     * Start recording data for the {@link gotovoid.de.gotovoid.database.model.Recording}
     * with the given id.
     *
